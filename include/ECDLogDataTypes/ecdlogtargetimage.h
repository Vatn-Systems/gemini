...
public:
    ...
    void Set(CTgtImg &img);                 //taken from EVO for display filtering
    void pstImg(CTgtImg& img, double pst);  //
    void accImg(CTgtImg& img, double acc);  //
    void subImg(CTgtImg& img, double scl);  //
