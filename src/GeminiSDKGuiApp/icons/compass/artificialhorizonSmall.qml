...
Rectangle {
    ...
    property double tickOffset: width * 0.39    // tick radius percent from centre
    ...
    Rectangle {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                // write a vertical line for 45º ticks
                Text {
                    text: "|"
                    font.pointSize: 10
                    font.bold: true
        ...
        // small compass ticks at 22.5deg spacing
        Repeater {
            model: 8
            width: parent.width
            height: parent.height
